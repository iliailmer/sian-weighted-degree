...
array=("new_seir" "new_saird" "new_seiddrf" "original_hiv2" "new_seirp" "new_siraqj" "new_ssaair" "new-goodwin-osc" "original_cholera" "original_nfkb" "hpv_simplified_1" "hpv_simplified_2" "new_qwwc" "new_siar")
