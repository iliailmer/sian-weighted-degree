...
# no tr. basis: new_mapk_1 new_mapk_3 new_seir2 new_seisehr original_chem_reac_network original_cholera original_daisy_ex3 original_daisy_mamil3 original_daisy_mamil4 original_hpv_mf_group1_subs original_hpv_mf_group4 original_lipolisys original_pharm original_seir original_seir2
