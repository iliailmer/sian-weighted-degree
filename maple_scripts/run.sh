#!/bin/bash
array=(original_lipolisys original_lv original_oral_glucose original_seir original_seir2 original_sir_r0 original_sirsforced original_slowfast original_treatment original_tumor new-akt bouwer new-cd8-cells new-goodwin-osc original_biohydrogenation original_chem_reac_network original_cholera original_daisy_ex3 original_daisy_mamil3 original_daisy_mamil4 original_hiv original_hiv2 new_saird new_seiddrf new_seir new_seir2 new_seirc new_seirp hpv_simplified_1 hpv_simplified_2 new_atopic_dematitis new_bone_model_full new_bone_model_simplified new_bone_reduced_supp new_brain_reduced new_PCSK9 new_qwwc new_seiajrc new_seiqrdc new_seisehr new_siar new_sidarthe new_sijru new_siraqj new_sircd new_sir_denom new_sliqr new_ssaair original_hpv_mf_group1_subs original_hpv_mf_group4 original_nfkb original_pharm new_seirahd)
