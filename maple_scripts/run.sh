...
for each in "${array[@]}"; do
    ...
    # for d in $each/*_trb_no_sigma_e_zero_char.mpl; do
    #     outname=(${d//"/"/ })
    ...
    #     fi
    # done
    # for d in $each/*_trb_no_sigma_e_pos_char.mpl; do
    #     outname=(${d//"/"/ })
    #     outname="${outname[1]::-4}.out"
    #     timename="time_${outname::-4}.out"
    #     echo $d
    ...
    for d in $each/*with_trb_zero_char.mpl; do
        outname=(${d//"/"/ })
        outname="${outname[1]::-4}.out"
        timename="time_${outname::-4}.out"
    ...
    # for d in $each/*_trb_pos_char.mpl; do
    #     outname=(${d//"/"/ })
    #     outname="${outname[1]::-4}.out"
    #     timename="time_${outname::-4}.out"
    #     echo $d
