...
WriteScripts(original_et_hat, system_vars[2], "original_chem_reac_network_original_no_trb", {}, PATH);
WriteScripts(system_vars[1], system_vars[2], "original_chem_reac_network_weights_no_trb", all_subs, PATH);
