...
WriteScripts(original_et_hat, system_vars[2], "original_daisy_mamil3_original_with_trb", {}, PATH);
WriteScripts(system_vars[1], system_vars[2], "original_daisy_mamil3_weights_with_trb", all_subs, PATH);
