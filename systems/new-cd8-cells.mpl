...
WriteScripts(original_et_hat, system_vars[2], "new-cd8-cells_original_no_trb", {}, PATH);
WriteScripts(system_vars[1], system_vars[2], "new-cd8-cells_weights_no_trb", all_subs, PATH);
