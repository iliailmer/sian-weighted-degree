# bone model, full	# 28 eqs, 96 params
...
substitutions := [
    ...
    nu124 = k124 * (1 - phi124) + k412 * phi124 * H18124 * (A24(t)*A180/(A240 * A18) ^ gamma24124),
    nu412 = k412 * (A4(t) / A40) * ((1-phi412) + phi412 * ((A17a + A17b(t)) / A170)),
    nu4u = (2 - H64) * ( 3 / 10 * GFR * A4(t) - H4u * H74u),
    nu514 = 464/1000 * nu412,
    # A17(t) = A17a(t) + A17b(t),
    nu145 = 464/1000 * nu124,
    nu5u = 88 / 100 * GFR * A5(t) - 88 / 100 * GFR * phi5u,
    nu35 = k35 * A3(t),
    nu58 = k58 * A5(t),
    nu85 = k85 * A8(t),
    k17aD = (k17D * A170 + k17Dprime * phik17D * A17a0 * phi17a-k17Dprime * phik17D * A170) / A170,
    k17Dprime = phi2 * k7D * k17D * H2017minus / pi0c - H2817D,
    k22s = k22D * A220*((A17a(t) + A17b(t)) / A170)^gamma1722 * alpha722 * (A7(t) / Vvasc) / (delta722 * ((A17a(t) + A17b(t)) / A170)^gamma1722 + (A7(t) / Vvasc))
...
sigma:= [
    ...
    diff(A16(t), t) = k17D * A170/pi0c * H2016plus - k17D * A170 * pi0c / (A160 * H2017plus) * A16(t),
    diff(A17a(t), t) = (K17D * A170 * pi) / (A160 * H2017plus) * A16(t) * phi17a * (k17aD / k17Dprime) - k17aD * A17a(t),
    diff(A17b(t), t) = (K17D * A170 * pi) / (A160 * H2017plus) * A16(t) * (1 - phi17a) * phik17D - k17Dprime * phik17D * A17b(t),
    diff(A18(t), t) = k18D * pi0c * A180 * H2418Splus - k18D * H2018Dplus * H2218Dminus * A18(t),
    diff(A19(t), t) = k1920 * A190 * ((A17a(t) + A17b(t)) / A170)^gamma1719S - k1920 * (A19(t) / A190)^gamma1920 * (A18(t) / A180)^gamma181920 * A19(t),
    diff(A20(t), t) = k1920 * (A19(t) / A190)^gamma1920 * (A18(t) / A180)^gamma181920 * A19(t) - 1000 * k1920 * A(20),
