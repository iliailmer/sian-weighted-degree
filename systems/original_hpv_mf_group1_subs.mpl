...
WriteScripts(original_et_hat, system_vars[2], "original_hpv_mf_group1_subs_original", {}, PATH);
WriteScripts(system_vars[1], system_vars[2], "original_hpv_mf_group1_subs_subs", all_subs, PATH);